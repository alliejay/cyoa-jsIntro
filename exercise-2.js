...
// X will not be logged because we didn't ask the console to log it.
// Then the letter is redefined to Y before the first console log.
// It's then redefined again to Z before the final console log.
...
var increaseScore = function(points) {
  score = score + points
}

var decreaseScore = function(points) {
  score = score - points
}
...
//accelerate() returns undefined which is why it would set the speed to NaN
//since undefined is not a number.
